...
public class inversion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("P(dólares)");

        jLabel2.setText("R(%t.i.)");

        jLabel3.setText("N(años)");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        double P,R,N,b,a,c,d,e;
        P=Float.parseFloat(String.valueOf(jTextField1.getText()));
        R=Float.parseFloat(String.valueOf(jTextField2.getText()));
        N=Float.parseFloat(String.valueOf(jTextField3.getText()));
        e=R*.100;
        a=(1+R);
        b=(a/100);
        c=Math.pow(b,N);
