...
public class peso extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Ingrese su altura en cm");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        double a,d,e,b;
        a=Float.parseFloat(String.valueOf(jTextField2.getText()));
        b=Integer.parseInt(String.valueOf(jTextField3.getText()));
        d=(b/100);
        e=a/Math.pow(d,2);
        jTextField1.setText(String.valueOf("Su índice corporal es de:"       +e));
